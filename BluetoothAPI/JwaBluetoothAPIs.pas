...
type
  ...
  _BLUETOOTH_SELECT_DEVICE_PARAMS = record
    ...
    pDevices: __PBLUETOOTH_DEVICE_INFO;           //  OUT pointer to an array for BLUETOOTH_DEVICE_INFOs.
...
function BluetoothDisplayDeviceProperties(hwndParent: HWND; var pbtdi: PBLUETOOTH_DEVICE_INFO): BOOL; stdcall;
