...
type
  TfrmEditSiteObjavOrder = class(TForm)
    ...
    qrySiteObjavsOB_ID: TIntegerField;
    ...
    qryObjavSITE_OBJAV_ADDED: TIntegerField;
    cdsObjavSITE_OBJAV_ADDED: TIntegerField;
  ...
  public
    ...
    class function ShowSiteObjavOrder(ag_id,sd_id,ob_id:integer): TModalResult;
  end;

implementation

uses dmCache, uEditSiteObjav, dm;
...
begin
   ...
   // Objav.ob_employer := cdsSiteObjavsSITE_CONTACT.AsString;
   // Objav.ob_tel := cdsSiteObjavsSITE_TEL.AsString;
   // Objav.ob_email := cdsSiteObjavsSITE_EMAIL.AsString;

    TfrmEditSiteObjav.AddSiteObjav(Point, cdsObjavOB_ID.AsInteger, 0, Objav, RefreshOrder);
end;
...
begin
    ...
    TfrmEditSiteObjav.EditSiteObjav(Point, cdsSiteObjavsSITE_OBJAV_ID.AsInteger, cdsSiteObjavsOB_ID.AsInteger, 0, RefreshOrder);
end;
...
class function TfrmEditSiteObjavOrder.ShowSiteObjavOrder(ag_id,sd_id,ob_id:integer):TModalResult;
var
