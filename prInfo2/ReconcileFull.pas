...
type
  TReconcileErrorFormFull = class(TForm)
    UpdateType: TLabel;
...
function HandleReconcileErrorFull(DataSet: TDataSet;  UpdateKind: TUpdateKind;
...
function HandleReconcileErrorFull(DataSet: TDataSet; UpdateKind: TUpdateKind;
  ReconcileError: EReconcileError): TReconcileAction;
var
  UpdateForm: TReconcileErrorFormFull;
begin
  UpdateForm := TReconcileErrorFormFull.CreateForm(DataSet, UpdateKind, ReconcileError);
  with UpdateForm do
  try
...
constructor TReconcileErrorFormFull.CreateForm(DataSet: TDataSet;
...
procedure TReconcileErrorFormFull.InitDataFields;
var
  I: Integer;
  FD: PFieldData;
  V: Variant;
...
procedure TReconcileErrorFormFull.InitUpdateData(HasCurValues: Boolean);
var
  FColCount: Integer;
begin
  FColCount := 1;
...
procedure TReconcileErrorFormFull.InitReconcileActions;
...
procedure TReconcileErrorFormFull.DisplayFieldValues(Sender: TObject);
var
  I: Integer;
  CurRow: Integer;
...
procedure TReconcileErrorFormFull.SetFieldValues(DataSet: TDataSet);
var
  I: Integer;
begin
  for I := 0 to FDataFields.Count - 1 do
...
procedure TReconcileErrorFormFull.AdjustColumnWidths;
var
  NewWidth, I: integer;
begin
  with UpdateData do
...
procedure TReconcileErrorFormFull.FormCreate(Sender: TObject);
begin
...
procedure TReconcileErrorFormFull.FormDestroy(Sender: TObject);
var
  I: Integer;
begin
...
procedure TReconcileErrorFormFull.UpdateDataSetEditText(Sender: TObject; ACol,
...
procedure TReconcileErrorFormFull.UpdateDataSelectCell(Sender: TObject; Col,
