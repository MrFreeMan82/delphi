...
type
  Tdata = class(TDataModule)
    ...
    qTNames: TSQLQuery;
    prvTNames: TDataSetProvider;
    cdsTNames: TClientDataSet;
    dsTNames: TDataSource;
    cdsSNamesSN_NAME: TStringField;
    cdsTNamesTN_NAME: TStringField;
    cdsOrganizationOP_ID: TIntegerField;
  private
