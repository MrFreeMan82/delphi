...
var WeekDayName1 = ["Вс", "Пн", "Вт", "Ср", "Чт", "Пт", "Сб"];
var WeekDayName2 = ["Пн", "Вт", "Ср", "Чт", "Пт", "Сб", "Вс"];
...
function RenderCssCal(bNewCal)
{
	...
	if (!winCal)
	{
		...
		cssStr = ".calTD {font-family: verdana; font-size: 11px; text-align: center; border:0; }\n";
		cssStr += ".calR {font-family: verdana; font-size: 11px; text-align: center; font-weight: bold;}";
